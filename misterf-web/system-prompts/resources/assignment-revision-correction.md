...
Rules to preserve:
- assistantMessage must be a concise teacher-facing message, not learner-facing assignment text.
...
- Preserve that this is an English-learning assignment: prompts may be in Spanish, but target learner output and accepted/correct answers must be English except for `quiz_understand_in_spanish`.
