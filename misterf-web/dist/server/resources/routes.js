...
import { handleArchiveResource, handleAcceptSharedResourceLink, handleCreateResourceFolder, handleMoveResourceToFolder, handleRemoveResourceFromFolder, handleRestoreResource, handleShareResourceToProfile, handleUpdateResourceFolder, handleUpdateResourceShareCollectResults, renderResourcesListPage, renderSharedByMePage, renderSharedResourcePage, } from './handlers.js';
export const resourcesRouter = express.Router();
resourcesRouter.get('/resources', renderResourcesListPage);
resourcesRouter.get('/resources/shared-by-me', renderSharedByMePage);
