...
import { handleChangePassword, handleCreateLesson, handleCreateChatRoom, handleCreateChatRoomConversation, handleCreateLessonConversation, handleCreatePracticeModuleCollection, handleCreateProfile, handleChatRoomContinue, handleGetChatRoomMessageEvaluation, handleChatRoomSendMessage, handleAcceptSharedPracticeModuleCollectionLink, handleArchiveLesson, handleArchivePracticeModuleCollection, handleAddPracticeModuleToCollection, handleDeleteLesson, handleAcceptSharedPracticeModuleLink, handleMovePracticeModuleCollectionItem, handleRemovePracticeModuleFromCollection, handleRestoreLesson, handleRestorePracticeModuleCollection, handleSetLessonFavorite, handleSetPracticeModuleCollectionFavorite, handleSharePracticeModuleCollectionToProfile, handleShareLessonToProfile, handleJoinChatRoom, handleUpdateChatRoom, handleUpdateLesson, handleUpdatePracticeModuleCollection, handleForgotPassword, handleLogin, handleLogout, handleResendVerification, handleResetPassword, handleSignup, handleSwitchProfile, handleUpdateProfile, handleVerifyEmail, renderHome, renderChangePassword, renderForgotPassword, renderLogin, renderResetPassword, renderSignup, renderVerifyNeeded, } from './auth/forms.js';
