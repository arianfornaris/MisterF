 ...
 */
function buildUserPromptHint(userPrompt) {
...
async function runVisionExtraction(input) {
    ...
    try {
        const result = await generateText({
            ...
            system: loadSystemPrompt('attachments/extraction.md')
...
export async function extractAttachmentText(input) {
    const { attachment } = input;
    const needsVision = attachment.sourceType === 'image' || attachment.sourceType === 'pdf';
    if (!needsVision) {
...
//# sourceMappingURL=attachmentExtraction.js.map