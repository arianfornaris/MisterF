...
function stripAssignmentUnsupportedFields(value) {
...
export const assignmentBlockSchema = z.preprocess(stripAssignmentUnsupportedFields, z.object({
    id: z
        .string()
        .trim()
        .min(3)
    ...
    .strict());
export const assignmentDraftSchema = z.preprocess(stripAssignmentUnsupportedFields, z.object({
