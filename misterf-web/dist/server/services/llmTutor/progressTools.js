        ...
        get_learner_progress: tool({
            ...
            execute: async ({ includeRecentEvents, recentEventLimit, vocabularyLimit }) => {
                ...
                return createTeacherOnlyContextEnvelope({
                    ...
                    purpose: 'Use this historical learner-progress snapshot to answer progress questions or personalize tutoring decisions when relevant.',
                    rules: [
...
//# sourceMappingURL=progressTools.js.map