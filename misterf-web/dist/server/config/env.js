...
export const env = {
    ...
    sceneMediaTtsModel: process.env.SCENE_MEDIA_TTS_MODEL ?? 'google/gemini-3.1-flash-tts-preview',
    ...
    signupBrowserCheckMode: process.env.SIGNUP_BROWSER_CHECK_MODE === 'enforce' ? 'enforce' : 'report',
    ...
    userFileStoragePublicBaseUrl: process.env.USER_FILE_STORAGE_PUBLIC_BASE_URL ?? '',
