 ...
 */
export async function normalizeImageAttachment(bytes, contentType) {
    const warnings = [];
...
function encodeForContentType(pipeline, contentType) {
...
//# sourceMappingURL=imageNormalization.js.map