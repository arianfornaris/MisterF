...
import { maxDigestChars, maxStagedBytesTotal, maxStagedPerUser, stagedTtlMs, } from './limits.js';
...
export function resetStagingStoreForTests() {
    entries.clear();
    stagedBytesTotal = 0;
}
//# sourceMappingURL=stagingStore.js.map