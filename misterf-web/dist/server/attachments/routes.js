...
import { handleApproveAttachment, handleDiscardAttachment, handleProcessUploadedAttachment, handleProcessUrlAttachment, } from './handlers.js';
...
attachmentsRouter.post('/attachments/process', rawUploadBody, handleProcessUploadedAttachment);
attachmentsRouter.post('/attachments/process-url', handleProcessUrlAttachment);
attachmentsRouter.post('/attachments/:attachmentId/approve', handleApproveAttachment);
