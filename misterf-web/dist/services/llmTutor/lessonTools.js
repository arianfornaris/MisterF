...
export function buildTutorLessonTools(input) {
    ...
    return {
        ...
        create_lesson: tool({
            description: 'Create a new lesson in the current profile. Provide title, description, and tutorInstructions. Infer them from the user request and chat context when possible.',
            inputSchema: z.object({
...
export function extractInferredLessonLinkBlocks(toolResults) {
    const actions = [];
...
//# sourceMappingURL=lessonTools.js.map