import type { GeneratedVocabularyItem } from './types.js';
...
export function assertUsableProgressMarkdown(markdown: string): void {
  if (!markdown) {
...
export function parseVocabularyJsonLines(text: string): GeneratedVocabularyItem[] {
