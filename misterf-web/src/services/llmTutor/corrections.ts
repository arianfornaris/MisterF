...
export function appendStructuredCorrectionRequest(
  ...
  messages.push({
    content: [
      ...
      'The only valid block types are: message, lesson_link, dialogue_character_message, dialogue_transcript, matching_pairs, quiz, translate_to_english_prompt, understand_in_spanish_prompt, fill_in_the_blank_input, fill_in_the_blank_choice, multiple_choice, unscramble_sentence, sentence_evaluation, conversation_title.',
    ].join('\n'),
    role: 'user',
  });
