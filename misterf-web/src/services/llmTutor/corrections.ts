...
export function appendStructuredCorrectionRequest(
  ...
  messages.push({
    content: [
      ...
      'The only valid block types are: message, dialogue_character_message, translate_to_english_prompt, understand_in_spanish_prompt, sentence_evaluation, conversation_title.',
    ].join('\n'),
    role: 'user',
  });
