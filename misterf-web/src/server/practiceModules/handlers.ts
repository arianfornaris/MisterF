...
import {
  ...
  generatePracticeModuleRevision,
...
type PracticeModuleDraftFormValues = {
  practiceModuleGenerationCreditExhausted?: boolean;
  practiceModuleFormValues?: PracticeModuleFormValues;
  practiceModuleGenerationError?: string;
  practiceModuleGenerationModalAutoOpen?: boolean;
  practiceModuleGenerationPrompt?: string;
  practiceModuleRevisionCreditExhausted?: boolean;
  practiceModuleRevisionError?: string;
  practiceModuleRevisionModalAutoOpen?: boolean;
  practiceModuleRevisionPrompt?: string;
  practiceModuleRevisionSuccess?: boolean;
};

const emptyPracticeModuleFormValues: PracticeModuleFormValues = {
  description: '',
  title: '',
  tutorInstructions: '',
};
...
export async function handleRevisePracticeModule(
  request: Request,
  response: Response,
): Promise<void> {
  const user = request.authUser;
