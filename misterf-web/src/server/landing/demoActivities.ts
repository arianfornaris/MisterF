import type { QuizDraft } from '../services/quizzes.js';

/**
 * The public example activities the landing page offers visitors, one picked at
 * random per visit.
 *
 * Why hand-authored fixtures instead of generated quizzes: they cost no
 * inference, they are reviewed in a pull request like any other content, they
 * are identical in every environment, and they cannot drift when a model
 * changes. `scripts/seed-landing-demos.ts` writes them into a dedicated demo
 * account; the seed is idempotent, so re-running it updates the content in
 * place and keeps the share links stable.
 *
 * Why only quizzes: a roleplay or a practice guide spends inference on every
 * turn, and this pool is opened by anonymous visitors. A quiz costs nothing
 * until it is submitted, and submission is already gated behind signup, so the
 * public demo has no unbounded cost.
 *
 * Why no `quiz_translate_to_english` / `quiz_understand_in_spanish` items: both
 * are Spanish-coupled by design, and a landing visitor has no instruction
 * language chosen yet. The remaining seven item kinds are all represented
 * across the set.
 *
 * Topics are drawn from the pilot audience — adult immigrant learners in South
 * Florida — so a teacher recognizes their own students in the examples.
 */
export type LandingDemoActivity = {
  /** Stable identity across seed runs. Never reuse a slug for new content. */
  slug: string;
  draft: QuizDraft;
};
...
export const landingDemoActivities: LandingDemoActivity[] = [
  {
    slug: 'first-day-personal-information',
    draft: {
      title: 'Your first day: personal information',
      description:
        'The questions you answer on your first day at a new job, and how to answer them clearly.',
      targetTopic: 'Giving personal information at work',
      level: 'A1',
      instructions:
        'Four short exercises about the questions people ask you on your first day at work.',
  ...
  },
  {
    ...
    draft: {
      ...
      description:
        'Ask whether a bus goes where you need, and understand the directions people give you.',
      targetTopic: 'Public transport and directions',
      level: 'A1',
      instructions:
        'Four exercises about getting somewhere by bus and asking for directions in the street.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
  ...
  },
  {
    ...
    draft: {
      ...
      description:
        'Call a clinic, ask for an appointment, and explain when you can come and why you need it.',
      targetTopic: 'Health appointments by phone',
      level: 'A2',
      instructions:
        'Four exercises about calling a clinic and booking an appointment for yourself.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_multiple_choice',
            prompt:
              'The receptionist asks: “Have you been here before?” You are a new patient. Which answer is correct?',
            selectionMode: 'single',
            options: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Write two or three sentences explaining why you need the appointment and when you can come.',
            placeholder: 'I need to see the doctor because…',
            rubric:
              'Look for a clear reason and a clear time. Present tenses are enough at this level.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Understand quantities, ask an employee for help, and check a price without hesitating.',
  ...
  },
  {
    ...
    draft: {
      ...
      description:
        'Talk about your day and your shift: when you start, what you do, and when you finish.',
      targetTopic: 'Daily routine and work schedules',
      level: 'A2',
      instructions:
        'Four exercises about describing your day and your working hours to someone new.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Describe a normal day at work: what time you start, what you do, and what time you finish.',
            placeholder: 'I start at…',
            rubric:
              'Look for present simple, clear times, and at least three activities in order.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Ask the right questions about rent, utilities, and deposits, then follow up in writing.',
      targetTopic: 'Renting a place to live',
      level: 'B1',
      instructions:
        'Two parts: the phone call first, then the message you send afterwards.',
      evaluationInstructions,
      sections: [
        {
          id: 'section_call',
      ...
      blocks: [
        ...
        },
        {
          ...
          item: {
            ...
            sentence:
              'Is the deposit ___ in the first month’s rent, or do I pay it ___?',
            blanks: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_multiple_choice',
            prompt:
              'Which question asks about what you pay every month besides the rent?',
            selectionMode: 'single',
            options: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Write a short message to the landlord asking to see the apartment. Say who you are, when you can visit, and ask them to confirm.',
            placeholder: 'Hello, my name is…',
            rubric:
              'Look for a greeting, a clear request, a specific time, and a polite closing.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Report a charge that is wrong without sounding aggressive, and ask for what you need.',
      targetTopic: 'Complaining politely about a service',
      level: 'B1',
      instructions:
        'Four exercises about explaining a billing mistake and asking the company to fix it.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
          ...
          item: {
            kind: 'quiz_multiple_choice',
            prompt:
              'You were charged twice. Which sentence is the best way to start the call?',
            selectionMode: 'single',
            options: [
        ...
        },
        {
          ...
          item: {
            ...
            sentence:
              'I {{blank}} charged twice for the same service, so I would like a {{blank}}.',
            blanks: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Explain the problem in three or four sentences: what happened, when, and what you would like the company to do.',
            placeholder: 'I am calling because…',
            rubric:
              'Look for past tenses for what happened, a clear request, and a polite tone throughout.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Answer the questions that open almost every interview, including the difficult one.',
      targetTopic: 'Job interviews',
      level: 'B1',
      instructions:
        'Four exercises about presenting your experience to an interviewer.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
        ...
        },
        {
          ...
          item: {
            ...
            sentence:
              'I ___ worked as a cook for five years, and I ___ still learning new recipes.',
            blanks: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_multiple_choice',
            prompt:
              'The interviewer asks about a weakness. Which answer works best?',
            selectionMode: 'single',
            options: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Answer in four or five sentences: “Tell me about a time you solved a problem at work.”',
            placeholder: 'Last year, at my previous job…',
            rubric:
              'Look for a situation, an action, and a result, told in past tenses.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Understand the words the school uses, and ask the teacher for something concrete.',
      targetTopic: 'Talking with your child’s teacher',
      level: 'B2',
      instructions:
        'Two parts: first the vocabulary the school uses, then what you say in the meeting.',
      evaluationInstructions,
      sections: [
        {
          id: 'section_words',
      ...
      blocks: [
        ...
        },
        {
          ...
          item: {
            ...
            sentence:
              'The teacher said my son is falling ___ in math and suggested extra ___.',
            blanks: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Write what you would say to the teacher: describe one thing you have noticed at home, and ask for one specific suggestion.',
            placeholder: "I've noticed that at home he…",
            rubric:
              'Look for one concrete observation and one clear, answerable question.',
          },
        },
      ],
    },
  },
  {
    ...
    draft: {
      ...
      description:
        'Raise a safety problem with your supervisor and request a day off without losing the shift.',
      targetTopic: 'Speaking up at work',
      level: 'B2',
      instructions:
        'Four exercises about two conversations every worker eventually needs.',
      evaluationInstructions,
      sections: [],
      blocks: [
        {
          ...
          item: {
            ...
            prompt: 'Complete the sentence.',
            sentence:
              'I’d like to ___ a safety problem: the floor near the freezer is always ___.',
            blanks: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_multiple_choice',
            prompt:
              'You need Friday off for a medical appointment. Which request works best at work?',
            selectionMode: 'single',
            options: [
        ...
        },
        {
          ...
          item: {
            kind: 'quiz_open_text',
            prompt:
              'Write a short email to your supervisor asking for a day off. Give the reason, the date, and offer a solution for your shift.',
            placeholder: 'Hi Sandra, I’m writing to ask…',
            rubric:
              'Look for a clear subject in the first line, a specific date, and an offer that solves the shift.',
          },
        },
      ],
    },
