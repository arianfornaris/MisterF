...
export const en: LocaleCatalog = {
  ...
  landing: {
    metaDescription:
      'Mister F turns the homework you already assign into guided practice your adult students can do from a link, and gives you a next-class report on what each one needs.',
    ...
    step5Body:
      'Who did it, what was missed most, and what is worth reviewing together. Ready before you walk in.',
