...
export const es: LocaleCatalog = {
  ...
  quizzes: {
    ...
    modifyWithAiCopy:
      'Usa este chat para pedir cambios concretos al quiz: detalles, bloques o secciones (crearlas, editarlas o quitarlas). Mister F aplicará los cambios y te responderá qué modificó.',
    ...
    addBlockHelp:
      'Tu pedido se enviará como mensaje al Chat IA y Mister F agregará el bloque.',
