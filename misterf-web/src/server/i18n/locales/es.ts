...
export const es: LocaleCatalog = {
  ...
  resources: {
    ...
    trash: 'Papelera',
    trashIntro:
      'Los recursos archivados permanecen aquí hasta que los restaures. No se pueden compartir mientras están archivados y vuelven a estar disponibles al restaurarlos.',
    ...
    noOtherProfiles:
      'No tienes otros perfiles disponibles para recibir esta carpeta.',
    shareLinkTitle: 'Compartir para practicar',
    shareLinkBody:
      'Quienes usen este enlace verán siempre la versión actual de esta carpeta.',
    link: 'Enlace',
    copy: 'Copiar',
    ...
    sharedStepQuizSubmitGuest:
      'Al terminar, crea una cuenta o inicia sesión para que Mr. F lo evalúe.',
    ...
    sharedStepRoleplayFeedback:
      'Al terminar, recibe una evaluación con lo que hiciste bien y qué mejorar.',
    ...
    shareCopyBody:
      'Para otros profesores. Quien abra este enlace recibe su propia copia, con las respuestas incluidas, para modificarla y usarla con sus estudiantes. Los resultados de sus estudiantes le llegan a esa persona, no a ti, y tus cambios posteriores no llegan a su copia.',
    shareCopyCreate: 'Crear enlace de copia',
    shareCopyRevoke: 'Desactivar enlace',
    shareCopyRevokeHint:
      'Quien ya hizo su copia la conserva. Si vuelves a crear el enlace, será uno nuevo.',
    ...
    sharedCopyNote:
      'La copia incluye las respuestas y queda en tus recursos. Si quien la compartió la cambia después, tu copia no cambia.',
    ...
    sharedResultsNotice:
      'La persona que compartió esta actividad verá tus respuestas y tu evaluación. Al comenzar, aceptas compartirlas.',
  ...
  mediaLibrary: {
    ...
    trashIntro:
      'Las medias archivadas permanecen aquí hasta que las restaures. Al restaurarlas vuelven a tu biblioteca de medios.',
    ...
    creditExhausted:
      'Necesitas más créditos para crear esta media. Compra créditos e inténtalo de nuevo.',
    detailIntro:
    ...
    failure: {
      contentPolicy:
        'No se pudo crear la media porque el contenido no cumple con nuestra política de contenidos.',
    },
    ...
    prompt: 'Prompt',
    promptGuide:
      'Describe la escena, quién aparece, dónde ocurre y qué skill de inglés debe practicar.',
    promptPlaceholder:
  ...
  auth: {
    ...
    guestQuiz: {
      ...
      intro: {
        signup:
          'Crea tu cuenta para ver la evaluación de «{{title}}», con la corrección de cada respuesta.',
    ...
    tutorChat: {
      ...
      intro:
        'Crea tu cuenta para conversar con Mr. F: te responde y te corrige mientras practicas. Empiezas con créditos iniciales.',
    },
    privacy: 'Privacidad',
    terms: 'Términos',
    documentTitle: {
  ...
  profiles: {
    ...
    modelHelp:
      'Se usa en las conversaciones nuevas de este perfil y en las actividades que generes con IA. A más potencia, más créditos por cada uso.',
    modelLite: 'Lite',
    modelLiteDesc:
      'El más rápido y económico. Puede fallar más en los ejercicios interactivos. Es el que menos créditos consume.',
    modelRegular: 'Regular',
    modelRegularDesc:
      'Rápido y confiable. Ideal para la práctica frecuente. Consume unas 3 veces más créditos que Lite.',
    modelAdvanced: 'Avanzado',
    modelAdvancedDesc:
      'La opción Pro para tareas que necesitan la máxima precisión. Consume unas 5 veces más créditos que Lite.',
  ...
  quizzes: {
    ...
    describePlaceholder:
      'Ejemplo: un quiz de 8 preguntas para practicar present perfect vs past simple con estudiantes B1...',
    create: 'Crear quiz',
    ...
    evaluatingCopy:
      'Estamos revisando tus respuestas. Esto puede tardar unos segundos; no cierres esta página.',
    ...
    confirmArchive:
      '¿Seguro que quieres archivar este quiz? Podrás recuperarlo después desde Archivados.',
    ...
    responsesSummaryNoneEvaluated:
      'Hay respuestas en curso, pero todavía ninguna evaluada.',
    aiSummaryTitle: 'Resumen con IA',
    aiSummaryIntro:
      'Genera un resumen escrito de cómo les fue a los participantes y qué conviene repasar.',
    ...
    summaryErrorEmpty:
      'Todavía no hay respuestas evaluadas para resumir.',
    summaryErrorGeneric:
      'No pude generar el resumen ahora mismo. Inténtalo otra vez.',
    noOtherProfiles:
      'No tienes otros perfiles disponibles para recibir este quiz.',
    shareLinkBody:
    ...
    studentInstructionsHelp:
      'Se le muestran al estudiante como encabezado del quiz.',
    modelInstructions: 'Instrucciones para el modelo (opcional)',
    modelInstructionsHelp:
      'Guía de calificación para la IA (rigor, qué aceptar, foco, tono del feedback). No se le muestran al estudiante y solo influyen en los ejercicios abiertos.',
    saveDetails: 'Guardar detalles',
    addBlock: 'Agregar bloque',
    quizBlocksAria: 'Bloques del quiz',
    addBlockHelp:
      'Mister F generará un bloque y podrás revisarlo antes de agregarlo.',
    addBlockDescribeLabel: 'Describe el bloque',
    addBlockPlaceholder:
      'Ej.: una pregunta de opción múltiple sobre el pasado simple con cuatro opciones…',
    ...
    modificationPlaceholder:
      'Ej.: cambia el nivel a A2, reescribe las instrucciones para el estudiante en un tono más cálido…',
    modificationHelp:
      'Solo cambia los detalles generales del quiz (título, descripción, tema, nivel e instrucciones). No toca los bloques.',
    generatingProposal: 'Generando la propuesta de cambios…',
    reviewModificationHelp:
      'Solo se muestran los campos que cambiarían. Compáralos antes de aprobar.',
    ...
    modifyBlockPlaceholder:
      'Ej.: haz las opciones más difíciles, cambia la oración a pasado, agrega un distractor…',
    modifyBlockHelp:
      'Solo cambia este bloque. Puedes cambiar el tipo y el nivel arriba antes de generar.',
    reviewBlockModificationHelp:
      'Compara el bloque actual con la propuesta antes de aprobar.',
    ...
    modifyBlocksPlaceholder:
      'Ej.: tradúcelos al inglés, baja todo a nivel A1, reorganiza en dos secciones, agrega tres preguntas más…',
    modifyBlocksHelp:
      'Cambia varios bloques y secciones a la vez. No toca los datos generales.',
    reviewBlocksModificationHelp:
      'Revisa todos los cambios propuestos antes de aprobarlos.',
  ...
  roleplays: {
    ...
    editCopy:
      'Ajusta los campos manualmente o usa las modificaciones con IA.',
    descriptionHelp:
      'Describe la situación completa: dónde ocurre, qué ha pasado, qué sabe el estudiante, qué papel interpreta, qué necesita conseguir y cualquier objetivo de práctica o restricción importante.',
    ...
    modificationLabel: 'Describe la modificación',
    modificationPlaceholder:
      'Por ejemplo: cambia el nivel a B1-B2, concreta más la situación y convierte al personaje de la IA en una recepcionista impaciente.',
    modificationHelp:
      'La IA puede modificar el título, la descripción, el nivel y ambos personajes. Nada se guardará hasta que apruebes la propuesta.',
    generatingProposal: 'Generando la propuesta de cambios…',
    reviewModificationHelp: 'Solo se muestran los campos que cambiarían. Compáralos antes de aprobar.',
    currentVersion: 'Antes',
    proposedVersion: 'Después',
  ...
  progress: {
    ...
    noGeneralBody:
      'Cuando finalices y resumas conversaciones, Mr. F empezará a construir esta vista de progreso.',
    vocabToWork: 'Vocabulario a trabajar',
    wordsToReinforce: 'Palabras y frases para reforzar',
    vocabIntro:
      'Palabras y frases detectadas en prácticas cerradas que conviene reforzar en próximas conversaciones.',
    seenIn: 'Visto en',
    andSep: ' y ',
    timesOne: '1 vez',
    ...
    noVocabSpecificBody:
      'Cuando los reportes detecten palabras o frases a reforzar, aparecerán aquí con su origen y fecha.',
    logKicker: 'Bitácora',
    closedPractices: 'Prácticas cerradas',
    logIntro:
      'Un registro compacto de las conversaciones y prácticas que ya alimentan el progreso del perfil.',
    practiced: 'Practicó',
    ...
    noEventsBody:
      'Los eventos aparecerán aquí con fecha cuando cierres conversaciones o prácticas evaluables.',
  },
  credits: {
    kicker: 'Cuenta',
    title: 'Créditos',
  ...
  home: {
    ...
    modeHelp:
      'Solo cambia con qué empieza el inicio de la app. No bloquea nada: en los dos modos puedes crear actividades, compartirlas y practicar con Mr. F.',
    modeLearn: 'Estoy aprendiendo',
    modeLearnShort: 'Aprendo',
    modeLearnHelp:
      'El inicio abre las actividades que te comparten, lo que dejaste a medias y un acceso directo a Mr. F.',
    modeTeach: 'Estoy enseñando',
    modeTeachShort: 'Enseño',
    modeTeachHelp:
      'Tu clase, tu hijo o cualquier persona a la que estés ayudando. El inicio abre lo que compartiste y las respuestas que van llegando.',
    newsTitle: 'Novedades',
  ...
  clientMisc: {
    ...
    cannotConnect:
      'No puedo conectar con el servidor en este momento. Revisa tu conexión y vuelve a intentar en unos segundos.',
  ...
  msg: {
    ...
    createResourceError:
      'No pude crear la guía de práctica ahora mismo. Inténtalo otra vez.',
    ...
    quizMetadataModificationFailed:
      'No se pudo generar esta modificación. Inténtalo de nuevo.',
    quizMetadataModificationNoChanges:
      'La IA no propuso cambios en los detalles. Prueba con una solicitud más específica.',
    quizMetadataModificationExpired:
      'Esta propuesta caducó o el quiz cambió. Genérala de nuevo antes de guardar.',
    quizBlockModificationFailed:
      'No se pudo generar esta modificación del bloque. Inténtalo de nuevo.',
    quizBlockModificationExpired:
      'Esta propuesta caducó o el quiz cambió. Genérala de nuevo antes de guardar.',
    quizBlocksModificationFailed:
      'No se pudo generar esta modificación de los bloques. Inténtalo de nuevo.',
    quizBlocksModificationNoChanges:
      'La propuesta no cambió ningún bloque. Prueba con otra instrucción.',
    ...
    draftCreatedRoleplay:
      'Listo. Creé una primera versión de "{{title}}" con {{count}} personajes.',
