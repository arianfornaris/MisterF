...
- [Built-In Scene Media Block](./features/built-in-scene-media-block.md): proposal for one tutor block that renders curated system scene media with optional image, audio, and script layers
