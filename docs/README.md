...
- [Resource Simplification V2](./features/resource-simplification-v2.md): planned simplification from separate resource areas into one `Recursos` catalog with assignments, practice guides, folders, and roleplays
