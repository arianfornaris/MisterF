...
Nota: planificado como V3 en el roadmap V1. Diseño detallado en
`docs/issues/home-suggestions-tracker.md` y
...
step can be split into dynamic sub-steps.
...
Capa de aula (classroom): roles de profesor/estudiante, grupos o rosters de
clase, fechas de entrega, dashboards del profesor, revisión de resultados de
...
opcional de turnos del estudiante.
