...
SCRIPTS = [
    ...
    },
    {
        ...
        "speakers": [
            {"id": "leo", "name": "Leo", "role": "person_needing_help", "voice": "Puck"},
            {"id": "ms_clark", "name": "Ms. Clark", "role": "helper", "voice": "Kore"},
        ],
        "transcript": [
            ("leo", "It is raining a lot. I forgot my umbrella."),
            ("ms_clark", "You can stand under my umbrella."),
            ("leo", "Thank you. Is the bus coming soon?"),
            ("ms_clark", "Yes, I can see it now."),
            ("leo", "Great. Now I am not so wet."),
        ],
    },
    {
        "sceneImageId": "shared-umbrella-bus-stop-01",
        ...
        "transcript": [
            ("leo", "I checked the weather this morning, but it said the rain would start later."),
            ("ms_clark", "That happens all the time. Come closer, or your backpack will get completely wet."),
            ("leo", "Thanks. I have homework in there, and I really do not want it to get ruined."),
            ("ms_clark", "No problem. The bus is turning the corner now, so we only need to wait a minute."),
            ("leo", "You are very kind. I will remember to bring my own umbrella next time."),
        ],
    },
    {
        "sceneImageId": "shared-umbrella-bus-stop-01",
        ...
        "transcript": [
            ("leo", "I should have known better than to trust a clear sky in the morning. Now everything in my bag is getting soaked."),
            ("ms_clark", "Step in a little closer. There is enough room under the umbrella, and it would be a shame to let your books take the worst of the storm."),
            ("leo", "Thank you. I did not want to bother anyone, but I was running out of dry places to stand."),
            ("ms_clark", "It is no bother. Public transport is much easier when people look out for each other."),
            ("leo", "That is true. A small favor can make a miserable wait feel almost pleasant."),
        ],
    },
    {
    ...
    },
    {
        ...
        "teachingFocus": ["food", "school", "sharing"],
        "speakers": [
            {"id": "mina", "name": "Mina", "role": "student_sharing_food", "voice": "Kore"},
            {"id": "sam", "name": "Sam", "role": "student_without_lunch", "voice": "Puck"},
        ],
        "transcript": [
            ("sam", "I forgot my lunch today."),
            ("mina", "You can have half of my sandwich."),
            ("sam", "Really? Thank you."),
            ("mina", "Yes. I also have an apple."),
    ...
    },
    {
        ...
        "teachingFocus": ["friendship", "school_lunch", "gratitude"],
        "speakers": [
            {"id": "mina", "name": "Mina", "role": "student_sharing_food", "voice": "Kore"},
            {"id": "sam", "name": "Sam", "role": "student_without_lunch", "voice": "Puck"},
        ],
        "transcript": [
            ("sam", "I was in such a hurry this morning that I left my lunch on the kitchen table."),
            ("mina", "That is okay. I packed more than I need, so we can share."),
            ("sam", "Are you sure? I do not want you to be hungry later."),
            ("mina", "I am sure. You can have half the sandwich, and we can split the fruit."),
            ("sam", "Thanks, Mina. I will bring something extra tomorrow, just in case you forget too."),
        ],
    },
    {
        "sceneImageId": "shared-lunch-classroom-01",
        ...
        "teachingFocus": ["social_awareness", "reciprocity", "natural_school_dialogue"],
        "speakers": [
            {"id": "mina", "name": "Mina", "role": "student_sharing_food", "voice": "Kore"},
            {"id": "sam", "name": "Sam", "role": "student_without_lunch", "voice": "Puck"},
        ],
        "transcript": [
            ("sam", "I cannot believe I managed to remember my project but leave my lunch sitting on the counter."),
            ("mina", "That sounds exactly like something that happens on a busy morning. Here, take half of my sandwich."),
            ("sam", "I appreciate it, but I do not want your kindness to turn into your afternoon hunger."),
            ("mina", "Do not worry. I brought more than enough, and sharing is easier than watching you pretend you are not hungry."),
            ("sam", "Fair point. Tomorrow I will pack something extra, partly as a thank-you and partly as emergency insurance."),
        ],
    },
    {
        ...
        "speakers": [
            {"id": "uncle_ben", "name": "Uncle Ben", "role": "helper", "voice": "Puck"},
            {"id": "nina", "name": "Nina", "role": "learner_cook", "voice": "Kore"},
        ],
        "transcript": [
            ("nina", "My pancake is too dark."),
            ("uncle_ben", "That is okay. Turn down the heat."),
            ("nina", "Now I pour a little batter."),
            ("uncle_ben", "Good. Wait for small bubbles."),
            ("nina", "This pancake looks much better."),
        ],
    },
    {
        "sceneImageId": "pancake-practice-kitchen-01",
        ...
        "transcript": [
            ("nina", "The first pancake burned because I left it in the pan too long."),
            ("uncle_ben", "That is how everyone learns. Lower the heat and watch for bubbles on top."),
            ("nina", "So I should wait until the edges look dry before I flip it?"),
            ("uncle_ben", "Exactly. Then slide the spatula under it and turn it over quickly."),
            ("nina", "This one is golden. I think breakfast is improving."),
        ],
    },
    {
        "sceneImageId": "pancake-practice-kitchen-01",
        ...
        "transcript": [
            ("nina", "The first pancake looks like evidence from a kitchen disaster."),
            ("uncle_ben", "It looks like practice. Pancakes are surprisingly good teachers because they show every mistake immediately."),
            ("nina", "So the heat was too high, and I waited too long before turning it."),
            ("uncle_ben", "Right. Keep the pan medium-hot, pour less batter, and flip when the surface has bubbles and the edges begin to set."),
            ("nina", "This one is actually golden. I suppose breakfast forgives beginners after all."),
        ],
    },
    {
